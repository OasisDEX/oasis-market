...
describe('Buying', () => {
  ...
  context('SAI for ETH', () => {
    ...
    it('with proxy and no allowance', () => {
      ...
      const finalSummary = nextFinalization
        .shouldMigrateAndCommitATrade(nextWillPay, nextFrom, nextWillReceive, nextTo);
  ...
  context('SAI for ERC20', () => {
    it('without proxy and allowance', () => {
      const from = 'SAI';
      const to = 'BAT';
      const willPay = '112.50';
      const willReceive = '0.5';
      const price = '225 BAT/SAI';
    ...
    it('with proxy and allowance', () => {
      ...
      const summary = finalization
        .shouldNotCreateProxy()
        .shouldNotSetAllowance()
        .shouldMigrateAndCommitATrade(nextWillPay, from, nextWillReceive, to);
