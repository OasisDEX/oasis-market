...
describe('Selling', () => {
  ...
  context('SAI for ETH', () => {
    it('without proxy and allowance', () => {
      ...
      const summary = finalization.shouldMigrateAndCommitATrade(willPay, from, willReceive, to);
    ...
    it('with proxy and no allowance', () => {
      ...
      const finalSummary = nextFinalization
        .shouldMigrateAndCommitATrade(willPayMore, switchFrom, willReceiveMore, switchTo);
    ...
    it('with proxy and allowance', () => {
      ...
      const summary = finalization
        .shouldNotCreateProxy()
        .shouldNotSetAllowance()
        .shouldMigrateAndCommitATrade(willPay, from, willReceive, to);
  ...
  context('SAI for ERC20', () => {
    it('without proxy and allowance', () => {
      const from = 'SAI';
      const to = 'REP';
      const willPay = '1';
      const willReceive = '0.006';
      const price = '150 REP/SAI';
    ...
    it('with proxy and no allowance', () => {
      ...
      const switchFrom = 'SAI';
      const willPayMore = '1';
      const willReceiveMore = '0.006';
      const newPrice = '150 REP/SAI';
      ...
      finalSummary.expectProxyNotBeingCreated();
      finalSummary.expectBought(willReceiveMore, switchTo);
      finalSummary.expectSold('0.99', switchFrom);
      finalSummary.expectPriceOf(newPrice);
    });
